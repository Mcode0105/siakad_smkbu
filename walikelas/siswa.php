                    ...
                    <table id="example1" class="table table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td> <a href="detail_absen.php?nisn=<?= $row['nisn']; ?>&kelas=<?=$row['kelas']; ?>" class="btn btn-info btn-sm"><i
                                            class="fa fa-eye"> Detail</i></a>
                                    <a href="input_absen_genap.php?id=<?= $row['id']; ?>" class="btn btn-primary btn-sm"><i
