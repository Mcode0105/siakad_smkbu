                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="box box-widget widget-user">
                            ...
                            $nisn = $_GET['nisn'];
                            $kelas = $_GET['kelas'];
                            $query1 = mysqli_query($conn, "SELECT * FROM rekap_absen_ganjil WHERE nisn = '$nisn' AND kelas = '$kelas' ");
                                ...
                                <div class="row">
                                    <div class="box-body">
                                        <table class="table table-bordered">
                                            ...
                                            $kelas = $_GET['kelas'];
                                            $nisn = $_GET['nisn'];
                                            $query = mysqli_query($conn, "SELECT * FROM rekap_absen_ganjil WHERE nisn = '$nisn' AND kelas = '$kelas' ");
                                            ?>
                                            ...
                                            <tr>
                                                ...
                                                <td><?= $as['sakitpagi']; ?></td>
                                                <td><?= $as['sakitsiang']; ?></td>
                                                <td> <a href="edit_ganjil.php?id=<?= $as['id']; ?>"
