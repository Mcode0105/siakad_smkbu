                        ...
                        <tbody>
                            ...
                            while ($row = mysqli_fetch_assoc($result)) : ?>
                                <tr>
                                    ...
                                    <td> <a href="detail_nilai_prakerin.php?nama=<?= $row['nama']; ?>&kelas=<?= $row['kelas'] ?>" class="btn btn-info btn-sm"><i class="fa fa-eye"> Detail</i></a>
                                        <a href="input_nilai_prakerin.php?nama=<?= $row['nama']; ?>&kelas=<?= $row['kelas'] ?>" class="btn btn-primary btn-sm"><i class="fa fa-edit"> input</i></a>
