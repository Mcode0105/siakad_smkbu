...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <a class="btn btn-success" href="nilai_prakerin.php"> <i class="fa fa-refresh"> Refresh</i> </a>
        <div class="box-body">
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td> <?= $a['t_akademik']; ?></td>
                                <td>
                                    <a href="view_datanilai_prakerin.php?jurusan=<?= $a['jurusan']; ?>&kelas=<?= $a['kelas']; ?>&tahun=<?= $a['t_akademik']; ?>" class="btn btn-info btn-sm"><i class="fa fa-eye"> Lihat Data Siswa</i></a>
