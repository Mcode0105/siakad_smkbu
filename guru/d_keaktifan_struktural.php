            ...
            <div class="box-body table-responsive">
                <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        $no = 1;
                         $nama = $_SESSION['guru']; 
                        $query = mysqli_query($conn, "SELECT * FROM struktural WHERE nuptk = '$nama' ");
                        ...
                        <tr>
                            ...
                            <td> <?= $a['nuptk']; ?></td>
                            <td>
                                <a href="detail_keaktifan_struktural.php?nama=<?= $a['nama']; ?>&jabatan=<?=$a['jabatan']; ?>"
                                    class="btn btn-info btn-sm"><i class="fa fa-eye"> detail</i></a>
                            </td>
                        </tr>
                        <?php
                            $no++;
