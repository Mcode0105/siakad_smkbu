                                ...
                                <form role="form" method="post" action="" enctype="multipart/form-data">
                                    <div class="box-body">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="nama" class="form-control" id="exampleInputEmail1" placeholder="no surat" require="">
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">No surat</label>
                                            <input type="text" name="no" class="form-control" id="exampleInputEmail1" placeholder="no" require="">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="keterangan" class="form-control" id="exampleInputEmail1" placeholder="keterangan surat" require="">
                                        </div>
                                        <div class="form-group">
                            ...
                            while ($row = mysqli_fetch_assoc($query)) : ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="hapus_s_masuk.php?id=<?= $row['id']; ?>" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i> hapus</a>
                                    </td>
                                </tr>
                            <?php
                                $no++;
