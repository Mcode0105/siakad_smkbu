                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="img/<?= $a['file']; ?>" class="btn btn-primary btn-sm"><i class="fa fa-download" download> download</i></a>
                                    <a href="hapus_kalender.php?id=<?= $a['id']; ?>" class="btn btn-danger btn-sm"><i class="fa fa-trash"> hapus</i></a>
                                </td>
                            </tr>
                        <?php
                            $no++;
