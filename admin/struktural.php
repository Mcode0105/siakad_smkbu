...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <a class="btn btn-success" href="struktural.php"> <i class="fa fa-refresh"> Refresh</i> </a>
        <div class="box-body">
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td> <?= $a['nuptk']; ?></td>
                                <td>
                                    <a href="hapusstr?id=<?= $a['id']; ?>" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></a>
                                </td>
                            </tr>
                        <?php
                            $no++;
