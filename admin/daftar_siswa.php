            ...
            <div class="col-md-7">
                ...
                <div class="box box-primary center">
                    <div class="box-body box-profile">
                        <img class="profile-user-img img-responsive img-circle" src="img/<?= $as['foto']; ?>" alt="User profile picture">
                        ...
                        <ul style="padding: 60px;" class="nav nav-stacked">
                            ...
                            <li class="list-group-item">
                                <b>Keluaraha<span class="pull-right badge bg-blue"><?= $as['kelurahan']; ?></span></b>
                            ...
                            <li class="list-group-item">
                                <b style=" font-size: 20px; color: green;font-family: sans-serif; margin-right: 100px; margin-left: 100px;">BIODATA
                                    AYAH
                                </b>
                            ...
                            <li class="list-group-item">
                                <b style=" font-size: 20px; color: orange;font-family: sans-serif; margin-right: 100px; margin-left: 100px;">BIODATA
                                    IBU
                                </b>
                        ...
                        <a style="margin-left: 30px;" href="edit_siswa.php?id=<?= $as['id']; ?>" class="btn btn-primary"><i class="fa fa-edit">Edit</i><b>
                                <a style="margin-right: 250px;" target="_blank" href="print_biodata.php?id=<?= $as['id']; ?>" class="btn btn-success"><i class="fa fa-print"></i><b>
                                        Print</b></a>
                    </div>
