                                ...
                                <form role="form" method="post" action="" enctype="multipart/form-data">
                                    <div class="box-body">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="kepada" class="form-control" id="exampleInputEmail1" placeholder="nama" require="">
                                        </div>
                                        <div class="form-group">
                ...
                <div class="box-body table-responsive">
                    <table id="example1" class="table table-bordered table-striped">
                        ...
                        <tbody>
                            <?php
                            $no = 1;
                            $query = mysqli_query($conn, "SELECT * FROM keterangan");
                            while ($row = mysqli_fetch_assoc($query)) : ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="hapus_keterangan.php?id=<?= $row['id']; ?>" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i> hapus</a>
                                    </td>
                                </tr>
                            <?php
                                $no++;
