    ...
    <section class="content">
        ...
        <div class="box">
            <div class="box-header with-border">
                ...
                <br>
                <a class="btn btn-success" href="pelanggaran_siswa.php"> <i class="fa fa-arrow-left"> kembali</i> </a>
                        ...
                        <tbody>
                            ...
                            while ($row = mysqli_fetch_assoc($result)) : ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="detail_pelanggaran.php?nama=<?= $row['nama']; ?>&kelas=<?= $row['kelas']; ?>" class="btn btn-info btn-sm"><i class="fa fa-eye"> detail</i></a>
                                        <a href="input_pelanggaran.php?nama=<?= $row['nama']; ?>&kelas=<?= $row['kelas']; ?>" class="btn btn-primary btn-sm"><i class="fa fa-edit"> input </i></a>
                                    </td>
