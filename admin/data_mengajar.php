                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td> <?= $a['nuptk']; ?></td>
                                <td>
                                    <a href="detail_keaktifan_guru.php?nama=<?= $a['nama']; ?>" class="btn btn-info btn-sm"><i class="fa fa-eye"> detail</i></a>
                                    <a href="input_data_mengajar.php?nama=<?= $a['nama']; ?>" class="btn btn-primary btn-sm"><i class="fa fa-edit"> input </i></a>
                                </td>
                            </tr>
                        <?php
                            $no++;
