                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td> <?= $a['t_akademik']; ?></td>
                                <td>
                                    <a href="view_siswa_pelanggaran.php?jurusan=<?= $a['jurusan']; ?>&kelas=<?= $a['kelas']; ?>&tahun=<?= $a['t_akademik']; ?>" class="btn btn-info btn-sm"><i class="fa fa-eye"> Lihat Data Siswa</i></a>
