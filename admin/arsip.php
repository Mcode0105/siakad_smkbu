                            ...
                            <div class="modal-body">
                                <form role="form" method="post" action="" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Keteragan</label>
                                            <input type="text" name="keterangan" class="form-control" id="exampleInputEmail1" placeholder="Keterangan" require="">
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Prihal surat</label>
                                            <input type="text" name="prihal" class="form-control" id="exampleInputEmail1" placeholder="Prihal" require="">
                                        </div>
                                        <div class="form-group">
                            ...
                            while ($row = mysqli_fetch_assoc($query)) : ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="hapus_arsip?id=<?= $row['id']; ?>" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i> hapus</a>
                                    </td>
                                </tr>
                            <?php
                                $no++;
